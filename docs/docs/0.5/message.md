...
The message component can be used to provide a note to the user. One use case could to notify the user of upcoming maintenance to your platform. If you want to permentantly display the message without any interactivity then the default behaviour provided by Bulma will be perfect. However, should you wish to create messages via Javascript, automatically dismiss messages or provide a dismiss button you'll need BulmaJS's message component.
...
- `dismissInterval` - This is an integer and specifies the amount of milliseconds the message is visible before it is automatically hidden.
